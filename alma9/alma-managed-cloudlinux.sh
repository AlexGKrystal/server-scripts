...
mkdir /root/krystal
cd /root/krystal && wget https://raw.githubusercontent.com/AlexGKrystal/server-scripts/main/alma9/alma-managed-cloudlinux-2.sh
...
echo "CPANEL=118" >> /etc/cpupdate.conf
