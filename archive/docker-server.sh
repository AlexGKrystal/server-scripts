...
# Setup SSH config to custom port (2121) and keys only
...
apt-get install docker-ce docker-ce-cli docker-compose containerd.io docker-buildx-plugin docker-compose-plugin -y
